...
import { faHome, faTrash, faPen, faEye, faShoppingCart } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
      <div className="flex flex-col justify-center p-3">
        {formulario && (
          ...
          >
            <input
              className=" border p-2 w-1/3 mt-3 focus:outline-none focus:ring focus:border-blue-300"
              placeholder="titulo"
              value={titulo}
              onChange={(e) => this.handleInput("titulo", e.target.value)}
            />
            <input
              className="border p-2 w-1/3 mt-3"
            ...
            {!idEdit && (
              <button
                className="w-full mt-6 bg-green-600 hover:bg-green-500 text-white font-semibold p-3"
            ...
            {cursos.map((curso) => (
              <tr>
                ...
                <td>
                  <button
                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                    onClick={() => this.agregarCarrito(curso.id)}
                  >
                  ...
                  <Link
                    ...
                    /* onClick={() => this.detalleCurso(curso.id)} */
                  >
